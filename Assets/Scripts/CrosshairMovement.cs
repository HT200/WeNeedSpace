...
public class CrosshairMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        float SCREEN_WIDTH = gameObject.transform.parent.gameObject.GetComponent<RectTransform>().rect.width;
        float SCREEN_HEIGHT = gameObject.transform.parent.gameObject.GetComponent<RectTransform>().rect.height;
